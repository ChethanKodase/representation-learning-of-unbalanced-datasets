...
for test_majority_class_index in class_labels:
    ...
    for test_data_noise_percent in [0.0, 0.1, 0.2, 0.5, 0.7]:
        ...
        for latent_dim in [4, 10]:
            ...
            plt.savefig('./results_plotting/latent_neighbourhood/MLP_AE/latent_dim'+str(latent_dim)+'/perturbation_level_'+str(int(test_data_noise_percent*100))+'_percent/class_'+str(classes[test_majority_class_index])+'_inputPerturbLevel_'+str(int(test_data_noise_percent*100))+'_recons.png')
